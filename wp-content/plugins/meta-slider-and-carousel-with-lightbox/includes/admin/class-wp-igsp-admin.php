...
class Wp_Igsp_Admin {
	...
	function wp_igsp_register_menu() {
		...
		// How It Work Page
		add_submenu_page( 'edit.php?post_type='.WP_IGSP_POST_TYPE, __('How it works, our plugins and offers', 'meta-slider-and-carousel-with-lightbox'), __('How It Works', 'meta-slider-and-carousel-with-lightbox'), 'manage_options', 'igsp-designs', array($this, 'igsp_designs_page') );
	...
	function wp_igsp_post_columns_data( $column, $post_id ) {
	    ...
	    switch ($column) {
	    	case 'wp_igsp_shortcode':
	    		...
	    		echo '<div class="wpos-copy-clipboard wp-igsp-shortcode-preview">[meta_gallery_slider id="'.$post_id.'"]</div> <br/>';
	    		echo '<div class="wpos-copy-clipboard wp-igsp-shortcode-preview">[meta_gallery_carousel id="'.$post_id.'"]</div>';
	    		break;
