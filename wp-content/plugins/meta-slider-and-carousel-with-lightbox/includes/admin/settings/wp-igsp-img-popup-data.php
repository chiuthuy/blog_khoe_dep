	...
	<form method="post" class="wp-igsp-attachment-form">
		...
		<table class="form-table">
			...
			<tr class="wp-igsp-pro-feature">
				<th>
					<?php _e('Description ', 'meta-slider-and-carousel-with-lightbox'); ?><span class="wp-igsp-pro-tag"><?php _e('PRO','meta-slider-and-carousel-with-lightbox');?></span>
				</th>
				<td>
					...
					<span class="description"><?php _e('Enter image description.', 'meta-slider-and-carousel-with-lightbox'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'meta-slider-and-carousel-with-lightbox'), WP_IGSP_PLUGIN_LINK); ?>
				</td>
			</tr>
			<tr class="wp-igsp-pro-feature">
				<th>
					<?php _e('Image Link ', 'meta-slider-and-carousel-with-lightbox'); ?><span class="wp-igsp-pro-tag"><?php _e('PRO','meta-slider-and-carousel-with-lightbox');?></span>
				</th>
				<td>
					<input type="url" name="wp_igsp_attachment_link" value="" class="large-text wp-igsp-attachment-link" disabled=""/>
					<span class="description"><?php _e('Enter image link.', 'meta-slider-and-carousel-with-lightbox'); ?></span><?php echo sprintf( __( ' Upgrade to <a href="%s" target="_blank">Premium Version</a> to get this option.', 'meta-slider-and-carousel-with-lightbox'), WP_IGSP_PLUGIN_LINK); ?>
				</td>
			</tr>
			<tr>
