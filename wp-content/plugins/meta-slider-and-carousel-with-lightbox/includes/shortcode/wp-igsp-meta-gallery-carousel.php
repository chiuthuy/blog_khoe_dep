...
function msacwl_gallery_carousel( $atts, $content ) {
	...
	if( $images ): ?>
		<div style="width: 400px;" class="msacwl-carousel-wrap msacwl-row-clearfix <?php echo $extra_class; ?>" data-conf="<?php echo htmlspecialchars(json_encode($slider_conf)); ?>">
			<div id="msacwl-carousel-<?php echo $unique; ?>" class="msacwl-carousel msacwl-common-slider msacwl-slider-popup">
				...
				?>
				<div class="msacwl-carousel-slide msacwl-slide" data-item-index="<?php echo $count; ?>" <?php echo $slider_height; ?>>
