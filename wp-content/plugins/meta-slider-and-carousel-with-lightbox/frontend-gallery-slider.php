...
if( ! defined( 'WP_IGSP_VERSION' ) ) {
	define( 'WP_IGSP_VERSION', '1.5.2' ); // Version of plugin
}
...
if( ! defined( 'WP_IGSP_PLUGIN_LINK' ) ) {
	define( 'WP_IGSP_PLUGIN_LINK', 'https://www.wponlinesupport.com/wp-plugin/meta-slider-carousel-lightbox/?utm_source=WP&utm_medium=Meta-Slider&utm_campaign=Features-PRO#fndtn-lifetime' ); // Plugin Link
}
...
if ( is_admin() ) {
	require_once( WP_IGSP_DIR . '/wpos-plugins/wpos-recommendation.php' );

	wpos_espbw_init_module( array(
							'prefix'	=> 'wp_igsp',
							'menu'		=> 'edit.php?post_type='.WP_IGSP_POST_TYPE,
							'position'	=> 2,
						));
}
